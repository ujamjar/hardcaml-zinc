...
(* OASIS_START *)
(* DO NOT EDIT (digest: 54645263ea9a0e08b92a98ca84d56eff) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-zinc";
          synopsis = "ZINC stack machine in HardCaml";
          description =
            Some
              [
                 OASISText.Para
                   "A hardware implementation of the OCaml ZINC stack machine"
              ];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("hardcaml-examples", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "hardcaml-zinc";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "hardcamlrun.ml"});
               Executable
                 ({
                     cs_name = "codes";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "codes.ml"});
               Executable
                 ({
                     cs_name = "monadinterp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "monadinterp.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-zinc.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-zinc";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\183\163\214\162\017A\026\161'\146\235\138R\147d[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
